...
<div class="main-sidebar" id="sidebar-scroll">
    ...
    <nav class="main-menu-container nav nav-pills flex-column sub-open">
        ...
        <ul class="main-menu">
            ...
            <li class="slide has-sub">
                <a href="javascript:void(0);" class="side-menu__item">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 side-menu__icon" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="0.1"><path d="M21 6.75736L19 8.75736V4H10V9H5V20H19V17.2426L21 15.2426V21.0082C21 21.556 20.5551 22 20.0066 22H3.9934C3.44476 22 3 21.5501 3 20.9932V8L9.00319 2H19.9978C20.5513 2 21 2.45531 21 2.9918V6.75736ZM21.7782 8.80761L23.1924 10.2218L15.4142 18L13.9979 17.9979L14 16.5858L21.7782 8.80761Z"></path></svg>
                    </svg>
                ...
                <ul class="slide-menu child1">
                    ...
                    <li class="slide">
                        <a href="full-calendar.html" class="side-menu__item">Course type</a>
                    </li>
                    <li class="slide">
                        <a href="gallery.html" class="side-menu__item">Course Category
                        </a>
                    </li>
                    <li class="slide">
                        <a href="sweet-alerts.html" class="side-menu__item">Course curriculum</a>
                    </li>
                    <li class="slide">
                        <a href="" class="side-menu__item">Course Description Video</a>
                    
                    </li>
                    <li class="slide">
                        <a href="" class="side-menu__item">Course details</a>
                    
                    </li>
                    <li class="slide">
                        <a href="" class="side-menu__item">Course Language</a>
